...
Thank you for helping improve Signal. Contributions should preserve its local-first, non-destructive safety model.
...
Never point tests at a real home directory or mutate live Claude, Codex, Gemini, tmux, or terminal configuration. Installer tests must use a temporary home. Do not add prompt, response, transcript, or secret content to Signal's protocol, state, fixtures, or logs.
